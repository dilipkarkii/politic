...
export default function Navbar() {
	...
	const userId = JSON.parse(getuserId).isAdmin;
	...
	return (
		<>
			<Disclosure as="nav" className="fixed inset-x-0 z-50 bg-white">
				{({ open }) => (
					<>
                    ...
                    /> */}
								...
								<div className="flex -mr-2 md:hidden">
									{/* Mobile menu button */}
									<Disclosure.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-gray-300 rounded-md hover:text-white hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
