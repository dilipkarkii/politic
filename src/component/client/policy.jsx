...
const Policy = () => {
	return (
		<>
			<Navbar />
			<div className="container h-full max-w-6xl px-8 pt-20 mx-auto p-7 ">
				<h2 className="text-2xl" style={{ textAlign: "center" }}>
					<b>PRIVACY POLICY</b>
				</h2>
				<p className="text-xl">Effective date: 2022-12-31</p>
				<p className="mt-2">
					1. <b>Introduction</b>
				</p>
				<p className="px-8">
					Welcome to <b> Public Affairs Nepal</b>.
				</p>
				<p className="px-8">
					<b>Public Affairs Nepal</b> (“us”, “we”, or “our”) operates{" "}
					<b>publicaffairsnepal.com</b> (hereinafter referred to as{" "}
					<b>“Service”</b>).
				</p>
				<p className="px-8">
					Our Privacy Policy governs your visit to <b>publicaffairsnepal.com</b>
				...
				<p>
					<b className="px-8">SERVICE</b> means the publicaffairsnepal.com
					website operated by Public Affairs Nepal.
				</p>
				<p className="px-8">
				...
				<div className="px-8">
					<p>
						Public Affairs Nepal uses the collected data for various purposes:
					</p>
				...
				<div className="px-8">
					...
					<p>
						If you are located outside Nepal and choose to provide information
						to us, please note that we transfer the data, including Personal
						Data, to Nepal and process it there.
					</p>
					<p>
					...
					<p>
						Public Affairs Nepal will take all the steps reasonably necessary to
				...
				<div className="px-8">
					...
					<p>
						...
						<b>business.publicaffairs.com@gmail.com</b>.
					</p>
					<p>
				...
				<div className="px-8">
					...
					<p>
						...
						us at <b>business.publicaffairs.com@gmail.com</b>.
					</p>
				...
				<p className="px-8">
					...
					by email: <b>business.publicaffairs.com@gmail.com</b>.
				</p>
				<p style={{ marginTop: "2em", fontSize: "0.7em", textAlign: "center" }}>
					This{" "}
					<a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
					was created for <b>publicaffairsnepal.com</b> by{" "}
					<a href="https://policymaker.io">PolicyMaker.io</a> on 2022-12-31.
				</p>
			</div>
		</>
	);
