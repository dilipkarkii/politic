      ...
      <div className="bg-slate-300">
        ...
        <div className="max-w-6xl p-3 px-4 py-20 mx-auto bg-slate-300">
          ...
          {loading ? (
            ...
            events.map((value) => (
              <div
                className="overflow-hidden bg-white shadow sm:rounded-lg mb-6"
                key={value.id}
              >
                <div className="grid md:grid-cols-12 gap-4 px-4 py-5 sm:px-6 bg-gray-50">
                  <h3 className="flex items-center md:col-span-4 text-lg font-medium leading-6 text-gray-500 ">
                    Upcomming Events :{" "}
